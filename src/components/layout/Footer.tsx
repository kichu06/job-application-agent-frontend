        ...
        <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
          ...
          <div className="flex flex-col gap-4 max-w-xs">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              AI-powered job application assistant. Upload your resume, paste a job description, and get instant analysis.
            </p>
            {/* GitHub link */}
            
             <a href="https://github.com/kichu06/job-application-agent-backend"
              target="_blank"
